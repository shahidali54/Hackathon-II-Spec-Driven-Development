...
import { signIn as authSignIn, signUp as authSignUp, signOut as authSignOut, checkAuthState, getAuthToken } from "@/lib/auth";
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <AuthContext.Provider value={{ ...state, signIn, signUp, signOut, clearError, getToken }}>
      {children}
...
// Page guard
export function useRequireAuth(): AuthState & { isReady: boolean; getToken: () => Promise<string | null> } {
  ...
  return { user, isAuthenticated, isLoading, error, isReady: !isLoading && isAuthenticated, getToken };
}
