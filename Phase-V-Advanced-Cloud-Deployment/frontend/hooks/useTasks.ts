...
interface UseTasksReturn extends TasksState {
  ...
  updateTask: (id: string | number, data: TaskUpdateData) => Promise<Task>;
  deleteTask: (id: string | number) => Promise<void>;
  toggleComplete: (id: string | number) => Promise<Task>;
...
export function useTasks(): UseTasksReturn {
  ...
  const updateTask = useCallback(async (id: string | number, data: TaskUpdateData) => {
