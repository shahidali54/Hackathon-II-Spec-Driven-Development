# Hackathon-II-Phase-V- Advanced Cloud Deployment Todo with AI Chat Agent

This is a full-stack, AI-powered Todo application developed as part of a hackathon using spec-driven-development methodology. The application features a modern web interface with secure user authentication, robust task management capabilities, advanced features (recurring tasks, due dates & reminders, priorities, tags), and an AI-powered chat assistant for natural language task management. The system implements event-driven architecture using Kafka and distributed runtime using Dapr.
...
- **Distributed Runtime**: Dapr for service-to-service communication
...
- **Advanced Task Features**: Priority selection, tag assignment, due date setting, recurrence scheduling
- **Enhanced UI**: Search, filter, and sort capabilities with visual indicators
...
- **Event-Driven Architecture**: Kafka integration for asynchronous operations
- **Distributed Runtime**: Dapr integration for service-to-service communication

### Advanced Features (Phase V)
- **Recurring Tasks**: Create tasks that repeat on schedules (daily, weekly, monthly, yearly)
- **Due Dates & Reminders**: Set due dates and receive timely notifications
- **Task Priorities**: Four priority levels (Low, Medium, High, Urgent) with visual indicators
...
- **Sorting**: Sort tasks by various properties (due date, priority, creation date, title)
- **Event-Driven Architecture**: Kafka integration for handling asynchronous operations
- **Distributed Runtime**: Dapr integration for service-to-service communication
...
- **Advanced Feature Support**: Natural language processing for priorities, tags, due dates, and recurring tasks
...
### Advanced Architecture (Phase V)
The application now features:
- **Event-Driven Services**: Kafka integration for handling asynchronous operations like reminders and recurring tasks
- **Distributed Runtime**: Dapr integration for service-to-service communication, state management, and pub/sub messaging
- **Separate Services**: Dedicated services for recurring tasks and notifications that communicate via events
- **Scalable Design**: Microservices architecture prepared for cloud deployment
...
### Tasks
- `GET /api/tasks` - Retrieve user tasks (with optional filtering by completion, priority, tags, due dates)
- `POST /api/tasks` - Create a new task (with priority, tags, due date, recurrence rules)
